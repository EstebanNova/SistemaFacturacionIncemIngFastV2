           ...
           echo '<tr>
                  ...
                  <td>
                    ...
                    <div class="btn-group">
                      ...
                      <button class="btn btn-info btnImprimirCotizacion" codigoVenta="'.$value["codigo"].'">

                        <i class="fa fa-print"></i>

                      </button>
                      <button class="btn btn-success btnEnviarCorreo" codigoVenta="'.$value["codigo"].'"
                    ...
                    if($_SESSION["modificarCotizaciones"] == "on"){
                         ...
                         echo '<button class="btn btn-warning btnEditarCotizacion" idVenta="'.$value["id"].'"><i class="fa fa-pencil"></i></button>';
                    }

                      
                    if($_SESSION["eliminarCotizaciones"] == "on"){
                      echo '<button class="btn btn-danger btnEliminarCotizacion" idVenta="'.$value["id"].'"><i class="fa fa-times"></i></button>
                      ';
                    }
