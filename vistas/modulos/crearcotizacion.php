      ...
      ======================================-->
            ...
            <div class="col-lg-7 col-xs-12">
                ...
                ======================================-->
                                ...
                                <div class="form-group">
                                    <label for="datepicker">Fecha Cotización</label>
                                    <div class="input-group date" data-provide="datepicker"
                                        ...
                                        <input type="text" class="form-control pull-right" id="datepicker"
                                            value="<?php echo $fecha_actual; ?>" placeholder="Fecha">
                ...
                ======================================-->
                                ...
                                <div class="form-group">
                                    ...
                                    <label for="nuevaVenta">Codigo Cotización</label>
                ...
                ======================================-->
                                ...
                                <div class="form-group">
                                    ...
                                    <label for="seleccionarCliente">Seleccione el Cliente resgistrado y/o digitelo para
                                        la busqueda</label>
                                    <div class="input-group">
                                        ...
                                        <select class="form-control select2" id="seleccionarCliente"
                                            name="seleccionarCliente" required style="width: 100%;">
                    ...
                    ?>
                                    ...
                                    <span class="input-group-addon"><button type="button" class="btn btn-default btn-sm"
                ...
                ======================================-->
                                <div class="form-group">
                                    ...
                                    <div class="input-group date" data-provide="datepicker"
                                        ...
                                        <input type="text" class="form-control pull-right" name="FechaVencimiento"
                                            id="FechaVencimiento" placeholder="Fecha Vencimiento"
                                            value="<?php echo $dteFechaVencimiento; ?>" required>
                ...
                ======================================-->
                                ...
                                <div class="form-group">
                                    <label for="cotizarA">Numero de contacto cliente</label>
                                    <div class="input-group">

                                        <span class="input-group-addon"><i class="fa fa-commenting"></i></span>

                                        <input type="text" class="form-control pull-right" name="cotizarA" id="cotizarA"
                                            placeholder="Ejemplo: 3205555555" value="<?php echo $venta["cotizarA"]; ?>">
                ...
                ======================================-->
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control pull-right" name="Observaciones"
                                            placeholder="observaciones" value="<?php echo $venta["Observaciones"]; ?>">
                ...
                ======================================-->
                                ...
                                <div class="form-group">
                                    ...
                                    <label for="plazoEntrega">Digite si tiene algun plazo de entrega, si no deje en
                                        0</label>
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control pull-right" name="plazoEntrega"
                                            id="plazoEntrega" placeholder="Tiempo estimado de entrega"
                                            value="<?php echo $datosEmpresa[0]["diasEntrega"]; ?>">
                ...
                ======================================-->
                                ...
                                <button type="button" class="btn btn-default hidden-lg" data-toggle="modal"
                                    data-target="#tabladeproductos2">Agregar producto</button>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="width: 40%">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <span class="input-group-addon"> <strong>Sub Total:</strong>
                                                                <i class="ion ion-social-usd"></i></span>

                                                            <input type="text" class="form-control input-lg"
                                                                id="nuevoSubTotalVenta" name="nuevoSubTotalVenta"
                                                                total="" placeholder="00000"
                                                                value="<?php echo $venta["neto"]; ?>" readonly required>
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <span class="input-group-addon"><strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Total:
                                                                </strong> <i class="ion ion-social-usd"></i></span>
                ...
                ======================================-->
                        ...
                        <div class="box-footer">
                            ...
                            <button type="button" class="btn btn-primary pull-left " data-toggle="modal"
                                data-target="#modalAgregarProducto" data-dismiss="modal">Nuevo Producto</button>
    ...
    <div class="modal-dialog">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <select class="form-control input-lg select2" id="nuevaCategoria" name="nuevaCategoria"
                  ...
                  ?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" class="form-control input-lg" name="nuevoStock" id="nuevoStock"
                                    value="1" placeholder="Stock">
        ...
        ======================================-->
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary btnGuardarProductoAjax" data-dismiss="modal">Guardar
                        producto</button>
    ...
    <div class="modal-dialog">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control input-lg" name="nuevoDocumentoId"
                                    id="nuevoDocumentoId" placeholder="Persona o contacto">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control input-lg" name="nuevaDireccion"
                                    id="nuevaDireccion" placeholder="Ingresar dirección">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control input-lg" name="nuevaFechaNacimiento"
                                    id="nuevaFechaNacimiento" placeholder="Ingresar fecha nacimiento"
                                    data-inputmask="'alias': 'yyyy/mm/dd'" data-mask value="1900/01/01">
        ...
        ======================================-->
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary btnGuardarClienteAjax" data-dismiss="modal">Guardar
                        cliente</button>
