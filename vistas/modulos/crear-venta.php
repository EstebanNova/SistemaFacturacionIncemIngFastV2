          ...
          <form role="form" method="post" class="formularioVenta">
            ...
            <div class="box-body">
              ...
              <div class="box">
               ...
               <div class="form-group">
               <label for="datepicker">Fecha Factura</label>
               <div class="input-group date" data-provide="datepicker"  data-date-format="yyyy/mm/dd">
                  ...
                  <input type="text" class="form-control pull-right" id="datepicker" value="<?php echo $fecha_actual; ?>"  placeholder="Fecha" readonly>
                ...
                <label for="nuevaVenta">Codigo Factura</label>
                ...
                <label for="seleccionarCliente">Seleccione el Cliente resgistrado y/o digitelo para la busqueda</label>
               ...
               <div class="input-group date" data-provide="datepicker" data-date-format="yyyy/mm/dd" required>
                ...
                <label for="plazoEntrega">Digite si tiene algun plazo de entrega, si no deje en 0</label>
